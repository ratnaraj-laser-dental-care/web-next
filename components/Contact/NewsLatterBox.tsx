...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-body-color border-opacity-25 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Scan the QR to connect with us on WhatsApp
      </p>
      <Image
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#fab011" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
