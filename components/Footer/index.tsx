        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[400px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  101, Moreshwar Apartment,
                  <br /> Opp. Ganesh Medical, Ahilyabai Chowk, <br />
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              ©2025 Ratnaraj Laser Dental Care. All rights reserved.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#fab011" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#fab011" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
