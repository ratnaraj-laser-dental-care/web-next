    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center  ${
          sticky
            ? "dark:shadow-sticky-dark fixed z-[9999] bg-white dark:bg-gray-dark !bg-opacity-80 shadow-sticky backdrop-blur-sm transition"
                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 text-dark dark:hover:text-white dark:text-white/70 border-b-2 ${
